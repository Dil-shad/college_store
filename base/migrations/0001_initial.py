# Generated by Django 4.2.6 on 2023-10-09 06:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('materials_provided', models.ManyToManyField(to='base.material')),
                ('purpose', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='base.purpose')),
            ],
        ),
        migrations.AddField(
            model_name='course',
